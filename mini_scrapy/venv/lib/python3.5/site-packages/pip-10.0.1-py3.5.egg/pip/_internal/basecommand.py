...
class Command(object):
    ...
    def main(self, args):
        ...
        logger_class = "pip._internal.untils.logging.ColorizedStreamHandler"
        handler_class = "pip._internal.untils.logging.BetterRotatingFileHandler"
        ...
        logging.config.dictConfig({
            ...
            "filters": {
                "exclude_warnings": {
                    "()": "pip._internal.untils.logging.MaxLevelFilter",
